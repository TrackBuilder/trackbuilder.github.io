...
Generator](https://www.privacypolicies.com/privacy-policy-generator/).
...
-   **Application** means the software program provided by the Company
    downloaded by You on any electronic device, named Stunt track
    builder VR

-   **Company** (referred to as either "the Company", "We", "Us" or
    "Our" in this Agreement) refers to Stunt track builder VR.
